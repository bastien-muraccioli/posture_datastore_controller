#include "PostureDatastoreController_WrenchTaskNullSpace.h"

#include "../PostureDatastoreController.h"

void PostureDatastoreController_WrenchTaskNullSpace::configure(const mc_rtc::Configuration & config) {}

void PostureDatastoreController_WrenchTaskNullSpace::start(mc_control::fsm::Controller & ctl_)
{
...
bool PostureDatastoreController_WrenchTaskNullSpace::run(mc_control::fsm::Controller & ctl_)
{
  auto & ctl = static_cast<PostureDatastoreController &>(ctl_);
...
void PostureDatastoreController_WrenchTaskNullSpace::teardown(mc_control::fsm::Controller & ctl_)
{
  auto & ctl = static_cast<PostureDatastoreController &>(ctl_);
...
EXPORT_SINGLE_STATE("PostureDatastoreController_WrenchTaskNullSpace", PostureDatastoreController_WrenchTaskNullSpace)
